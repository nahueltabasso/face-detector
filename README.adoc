...
2. link:use.adoc[Use]
3. link:apiComments.adoc[API Comments]
4. link:contributions.adoc[Contributions]
5. link:licences.adoc[Licences]
6. link:contact.adoc[Contact]

include::gettingStarted.adoc[]
include::use.adoc[]
include::apiComments.adoc[]
include::contribucion.adoc[]
